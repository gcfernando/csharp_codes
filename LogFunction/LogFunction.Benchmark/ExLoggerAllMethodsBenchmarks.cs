...
public class ExLoggerAllMethodsBenchmarks
{
    ...
    [Benchmark] public void Log_Generic_Message() => ExLogger.Log(_logger, LogLevel.Information, "Generic message");
    [Benchmark] public void Log_Generic_Message_Exception() => ExLogger.Log(_logger, LogLevel.Warning, "Warn with exception", _ex);
    [Benchmark] public void Log_Generic_Template_Exception() => ExLogger.Log(_logger, LogLevel.Error, _ex, "Order {OrderId} failed", 123);
    ...
    [Benchmark] public void LogErrorException() => ExLogger.ExLogErrorException(_logger, _ex, "System Error", moreDetailsEnabled: true);
    [Benchmark] public void LogCriticalException() => ExLogger.ExLogCriticalException(_logger, _ex, "Fatal Error", moreDetailsEnabled: true);

    [Benchmark] public void BeginScope_Single() => ExLogger.ExBeginScope(_logger, "RequestId", Guid.NewGuid()).Dispose();
    [Benchmark]
